...
//    String root = "http://127.0.0.1:8000/";
    ...
    @GET("post/filmslocs/list/")
    Call<List<LocationsByFilmModel>> getLocationsWhereFilms();

    @GET("post/filmslocs/{id}")
    Call<List<LocationsByFilmModel>> getLocationWhereFilmById(@Path(value = "id", encoded = true) Integer id);
    //Call<List<LocationsByFilmModel>> getLocationWhereFilmById(@Path(value = "id", encoded = true) ArrayList<Integer> id);
